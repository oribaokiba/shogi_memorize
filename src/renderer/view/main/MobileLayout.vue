    ...
    <div class="full row">
      <div class="column">
        ...
        <HorizontalSelector
          ...
          :items="[
            { label: '定跡暗記', value: BottomUIType.MEMORIZE },
      ...
      >
        ...
        <HorizontalSelector
          ...
          :items="[
            { label: '定跡暗記', value: SideUIType.MEMORIZE },
...
const bottomUIType = ref(BottomUIType.MEMORIZE);
const sideUIType = ref(SideUIType.MEMORIZE);
